...
class AdamW:
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.995), eps=1e-8, wd=0.02):
        self.params = params
...
def evolve():
    ...
    for epoch in range(epochs):
        ...
        dt = time.time() - t0
        print(f"EP:{epoch:02d} | LOSS:{total_loss:.4f} | ACC:{total_acc:.4f} | {N/dt:.0f} s/s | LR:{optimizer.lr*lr_mult:.6f}")
