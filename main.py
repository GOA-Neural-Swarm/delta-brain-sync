...
class A:
    def __init__(self, d, h=8, g=2):
        ...
        self.wq, self.wk = Ln(d, d), Ln(d, (h//g)*self.hd)
        self.wv, self.wo = Ln(d, (h//g)*self.hd), Ln(d, d)
        self.s = self.hd**-.5
    def _rp(self, t, c, s):
        r, i = t[..., ::2], t[..., 1::2]
...
class M:
    def __init__(self, d, n=4, k=2):
        ...
        self.w2 = [T(np.random.normal(0,d**-.5,(d*2, d))) for _ in range(n)]
...
class Model:
    def __init__(self, di, dm, do, dep=2):
        self.emb, self.bl = Ln(di, dm), [B(dm) for _ in range(dep)]
        self.fn, self.hd = N(dm), Ln(dm, do)
        self.ps = []
        self._gp(self)
    def _gp(self, o):
