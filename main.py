...
class A:
    def __call__(self, x): self.o = 1 / (1 + np.exp(-x.clip(-20, 20))); return self.o
    def backward(self, d): return d * self.o * (1 - self.o)

class L:
    def __init__(self, i, o): self.w, self.b = R(i, o) * (2 / i)**.5, np.zeros(o)
...
class M:
    def __init__(self, i=784, h=128, o=10, c=3):
        ...
        self.v = [x * 0 for x in self.m]; self.t = 0
    def fwd(self, x):
